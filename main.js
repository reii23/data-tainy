  ...
  document.addEventListener("DOMContentLoaded", function () {
    const tracklist = [
      ...
      { title: "La baby (feat Daddy Yankee,Feid y Sech)", file: "10-lababy.mp3", producer: "Tainy", duration: "3:02" },
      { title: "Me jodí... (feat Arcángel)", file: "11-mejodi.mp3", producer: "Tainy", duration: "3:21" },
      { title: "Volver (feat Rauw Alejandro, Skrillex y Four Tet)", file: "12-volver.mp3", producer: "Tainy · Skrillex · Four Tet", duration: "3:05" },
    ...
    tracklist.forEach((track, index) => {
        ...
        audioProducer.classList.add("audio-producer");
        ...
        audioInfo.appendChild(audioProducer);
